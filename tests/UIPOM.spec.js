...
test("End to End Scenario", async ({ browser }) => {
  ...
  await loginPage.validLogin("kaushik.aryaan@gmail.com", "Test@1234");
  ...
  await paymentMethodPage.chooseAutoSuggestionData(countryName, "ind");
  ...
  //wait page.locator("button[routerlink*='myorder']").click();
